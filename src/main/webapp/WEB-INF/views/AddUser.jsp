...
<body
	...
	<div class="sidenav" style="width: 20%">
		...
		<a href="/AddBook" class="w3-bar-item w3-button">Add Book</a> <a
			...
			href="/issueBook" class="w3-bar-item w3-button">Issue Book</a> <a
			href="view_user/view_user_home.jsp" class="w3-bar-item w3-button">View
			User Details</a> <a href="return_book/return_book_home.jsp"
